...
<html>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <div class="table-container">
        ...
        <a href="orders.php" class="btn btn-dark" style="margin-left:80%;">  Back  </a>        <br>
        <br>
        <?php
 ...
 { 
  ...
  <br>
  <center><a href="invoice_backend.php?o_id=<?php echo $o_id ?>" class="btn btn-success" ">  Generate Invoice  </a>  </center>
